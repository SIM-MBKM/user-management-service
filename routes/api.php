...
Route::middleware([
    ...
    Route::get('/v1/user/service/users', [UserController::class, 'getAllUsers']); //done
    Route::get('/v1/user/service/by-user-id/{userId}', [UserController::class, 'getUserById'])->where('userId', '[0-9a-fA-F\-]{36}'); //done
});
...
Route::middleware([
    ...
    Route::get('/v1/user/service/users/me', [UserController::class, 'getUserMe']); //done
});
...
Route::middleware([
    ...
    Route::patch('/v1/user/service/users/update/me', [UserController::class, 'updateUserMe']); //done
});

Route::middleware([
    'check.permission:user_management_service,update-all,users'
])->group(function () {
    Route::patch('/v1/user/service/users/update/{userId}', [UserController::class, 'updateUserById'])->where('userId', '[0-9a-fA-F\-]{36}'); //done
});
