...
# Install the PHP sockets extension (ADDED - for php-amqplib/RabbitMQ)
...
# ✅ TAMBAHAN: Copy www.conf ke container (bukan mount)
...
#####################################
# Laravel Application Setup (REMOVED COPY):
#####################################

# ❌ HAPUS: Jangan copy application files - akan di-mount via volume
# COPY . .

# ❌ HAPUS: Directory creation - akan dihandle oleh entrypoint
# RUN mkdir -p storage/logs storage/framework/{cache,sessions,views} bootstrap/cache

# ❌ HAPUS: Permission setting - akan dihandle oleh entrypoint  
